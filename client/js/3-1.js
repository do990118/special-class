...
// //   // const result = !value ? getCss(node, prop) : setCss(node, prop, value)
// //   // return result;
// // }

// // const css = (node, prop, value) => !value ? getCss(node, prop) : setCss(node, prop, value)

// // css('h1', 'color', 'red') // setter

// // css('h1', 'fontSize') // getter
...
//     throw new Error('getAttr 함수의 두 번째 인수는 문자형이어야 합니다')
//   }
//   return node.getAttribute(prop)
// }

// console.log(getAttr(h1, 'data-index'))
...
//   }
//   if(!value) throw new Error('setAttr 함수의 세 번째 인수는 필수 입력값입니다')
